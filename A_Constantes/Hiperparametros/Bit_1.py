...
TOPO_DES = {
    ...
    "D1": {"tamanhos":TAMANHOS_NEUR_DES, "camadas": [10], "fator": [1], "funcoes": ["S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S100"]},
    "D2": {"tamanhos":TAMANHOS_NEUR_DES, "camadas": [12], "fator": [1], "funcoes": ["S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S100"]},
    "D3": {"tamanhos":TAMANHOS_NEUR_DES, "camadas": [14], "fator": [1], "funcoes": ["S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S100"]},
...
TOPO_AES = {
    "S1": {"tamanhos":TAMANHOS_NEUR_AES, "camadas": [2],  "fator": [4], "funcoes": ["S1", "S100"]},

    "D1": {"tamanhos":TAMANHOS_NEUR_AES, "camadas": [10], "fator": [1], "funcoes": ["S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S100"]},
    "D2": {"tamanhos":TAMANHOS_NEUR_AES, "camadas": [12], "fator": [1], "funcoes": ["S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S100"]},
    "D3": {"tamanhos":TAMANHOS_NEUR_AES, "camadas": [14], "fator": [1], "funcoes": ["S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S1", "S100"]},
